...
const About = () => {
  return (
    <section className="w-full flex flex-col gap-45 pb-10">
      {/* about me */}
      <div className="w-full flex flex-col lg:flex-row justify-between gap-20 px-5 lg:px-10">
        <div className="w-full lg:w-1/2 flex flex-col space-y-10">
          ...
          <p className="text-2xl lg:text-4xl font-extralight">
      ...
      {/* more about me */}
      <div className="flex flex-col items-center gap-30 px-5 lg:px-10">
        <h1 className="text-4xl lg:text-6xl font-bold">More about me</h1>

        {/* timeline */}
        <Timeline />

        <p className="lg:w-1/2 text-2xl lg:text-4xl font-extralight text-center">
